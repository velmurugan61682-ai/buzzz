...
const appJsxPath = path.join(__dirname, "..", "apps", "web", "src", "App.jsx");
...
if (html.includes("cdn.tailwindcss.com")) {
  console.error("FAIL: apps/web/index.html loads Tailwind from the CDN; build it instead");
  process.exit(1);
}
const mainJsx = fs.readFileSync(path.join(__dirname, "..", "apps", "web", "src", "main.jsx"), "utf-8");
