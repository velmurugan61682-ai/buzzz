export const PLATFORM_META = {
  ...
  instagram: { name: "Instagram", icon: "instaxbot", color: "#E63800", channel: "Instagram" },
...
export const getPlatformMeta = (platform) => {
  if (!platform) return PLATFORM_META.whatsapp;
  const key = String(platform).toLowerCase();
  if (key === "instaxbot") return PLATFORM_META.instagram;
  if (key === "gowhats" || key === "channelbot") return PLATFORM_META.whatsapp;
  return PLATFORM_META[key] || PLATFORM_META.whatsapp;
};
